# @Brandon Thacker
# www.codingbat.com PYTHON String1 Problems and Solutions 
...
chars of the original string. The string length will be at least 
2. 
...
def left2(str):
	subFront = str[0:2]
	subRest = str[2:len(str)]
	return subRest + subFront